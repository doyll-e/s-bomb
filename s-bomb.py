...
def devloper():
    try:
        ...
        time.sleep(0.1)
        print(Fore.CYAN+"  ["+Fore.LIGHTCYAN_EX+"2"+Fore.CYAN+"]  "+Fore.RED+" Github : "+Fore.LIGHTCYAN_EX+"https://github.com/ariiann")
        time.sleep(0.1)
        print(Fore.CYAN+"  ["+Fore.LIGHTCYAN_EX+"3"+Fore.CYAN+"]  "+Fore.RED+" Backup section : "+Fore.LIGHTCYAN_EX+"https://t.me/a0_0in")
...
def sms():
  #  try:
          ...
          print(Fore.GREEN+"pleas enter the number without 0 :)")
...
def main():
    try:
        ...
        if start == '1':
            ...
            clear()
            print(Fore.RED+"Thank you for your choice  ;)"+Fore.WHITE)
            sys.exit()
        elif start == '':
            input(Fore.RED+'\n    Enter Data |: ')
            main()
